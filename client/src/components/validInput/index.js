...
export default function ValidInput(props) {
    ...
    if (props.isValid === false){
        if (props.type === 'text'){
            return (
                <Fragment>
                    <input type={props.type} onKeyDown={props.onKeyDown} onChange={props.onChange} className='credentials__not__match' placeholder={props.placeholder}/>
    ...
    return <input type={props.type} onKeyDown={props.onKeyDown} onChange={props.onChange} className='credentials__input' placeholder={props.placeholder}/>;
}